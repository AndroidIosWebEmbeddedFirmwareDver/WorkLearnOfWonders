...
import com.wondersgroup.hs.healthcloud.common.view.wheelview.OptionsPickerView;
import com.wondersgroup.hs.healthcloud.common.view.wheelview.adapter.ArrayWheelAdapter;
import com.wondersgroup.hs.healthcloud.common.view.wheelview.lib.WheelView;
...
public class WheelOptions<T> {
    ...
    private OptionsPickerView.OnOptionsSelectListener optionsSelectChangeListener;
...
//		// 添加联动监听
	 ...
	 * @param items
     */
	public void setItemsVisiable(int items){
		wv_option1.setItemsVisible(items);
		wv_option2.setItemsVisible(items);
		wv_option3.setItemsVisible(items);
	}
	/**
	 * 分别设置第一二三级是否循环滚动
    ...
    public void setEnabled(boolean enable1) {
        wv_option1.setEnabled(enable1);
    }

    public void setEnabled(boolean enable1, boolean enable2) {
        wv_option1.setEnabled(enable1);
        wv_option2.setEnabled(enable2);
    }

	public void setEnabled(boolean enable1, boolean enable2, boolean enable3) {
        wv_option1.setEnabled(enable1);
        wv_option2.setEnabled(enable2);
        wv_option3.setEnabled(enable3);
	}

    public void setOnSelectChangeListener(OptionsPickerView.OnOptionsSelectListener optionsSelectListener) {
        this.optionsSelectChangeListener = optionsSelectListener;
        if (optionsSelectChangeListener != null)
            wv_option1.setOnItemSelectedListener(wheelListener_option1);
        if (optionsSelectChangeListener != null)
            wv_option2.setOnItemSelectedListener(wheelListener_option2);
