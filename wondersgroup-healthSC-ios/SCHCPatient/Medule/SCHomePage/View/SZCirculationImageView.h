...
typedef void(^selectIndexImageView)(NSInteger index);
@interface SZCirculationImageView : UIView

@property (nonatomic,strong) selectIndexImageView selectBlock;
@property (nonatomic, assign) NSInteger     index;//点击第几个图片
/**
 *  图片填充模式
 */
