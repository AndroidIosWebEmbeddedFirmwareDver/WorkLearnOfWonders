package com.wondersgroup.hs.healthcloud.common.view.swipeback;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, com.wondersgroup.hs.healthcloud.common.R.attr.SwipeBackLayoutStyle);
    }
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.wondersgroup.hs.healthcloud.common.R.styleable.SwipeBackLayout, defStyle,
                com.wondersgroup.hs.healthcloud.common.R.style.SwipeBackLayout);

        int edgeSize = a.getDimensionPixelSize(com.wondersgroup.hs.healthcloud.common.R.styleable.SwipeBackLayout_edge_size, -1);
        if (edgeSize > 0)
            setEdgeSize(edgeSize);
        int mode = EDGE_FLAGS[a.getInt(com.wondersgroup.hs.healthcloud.common.R.styleable.SwipeBackLayout_edge_flag, 0)];
        setEdgeTrackingEnabled(mode);

        int shadowLeft = a.getResourceId(com.wondersgroup.hs.healthcloud.common.R.styleable.SwipeBackLayout_shadow_left,
                com.wondersgroup.hs.healthcloud.common.R.mipmap.shadow_left);
        int shadowRight = a.getResourceId(com.wondersgroup.hs.healthcloud.common.R.styleable.SwipeBackLayout_shadow_right,
                com.wondersgroup.hs.healthcloud.common.R.mipmap.shadow_right);
        int shadowBottom = a.getResourceId(com.wondersgroup.hs.healthcloud.common.R.styleable.SwipeBackLayout_shadow_bottom,
                com.wondersgroup.hs.healthcloud.common.R.mipmap.shadow_bottom);
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        try {
            ...
            if (result) {
                UIUtil.hideSoftInput((Activity)getContext());
            }
            return result;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            if (((Activity)getContext()).getCurrentFocus() != null) {
                if (((Activity)getContext()).getCurrentFocus()
                        .getWindowToken() != null) {
                    UIUtil.hideSoftInput((Activity)getContext());
                }
            }
