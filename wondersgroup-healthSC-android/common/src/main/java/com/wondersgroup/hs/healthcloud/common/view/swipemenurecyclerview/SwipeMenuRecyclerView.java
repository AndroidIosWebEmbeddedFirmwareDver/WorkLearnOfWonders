...
import com.wondersgroup.hs.healthcloud.common.view.swipemenurecyclerview.touch.DefaultItemTouchHelper;
import com.wondersgroup.hs.healthcloud.common.view.swipemenurecyclerview.touch.OnItemMoveListener;
import com.wondersgroup.hs.healthcloud.common.view.swipemenurecyclerview.touch.OnItemMovementListener;
import com.wondersgroup.hs.healthcloud.common.view.swipemenurecyclerview.touch.OnItemStateChangedListener;
...
public class SwipeMenuRecyclerView extends RecyclerView {
    ...
    private BaseRecyclerView.OnItemClickListener mOnItemClickListener;
    ...
    public SwipeMenuRecyclerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            mItemSelectorId = a.getResourceId(R.styleable.SwipeMenuLayout_android_listSelector, 0);
            a.recycle();
        }
    }
    ...
    public void setAdapter(Adapter adapter) {
        mSwipeMenuAdapter = new SwipeMenuAdapter(this, adapter);
        mSwipeMenuAdapter.setSwipeMenuCreator(mDefaultMenuCreator);
        mSwipeMenuAdapter.setSwipeMenuItemClickListener(mDefaultMenuItemClickListener);
        mSwipeMenuAdapter.setItemSelectorId(mItemSelectorId);
        mSwipeMenuAdapter.setOnItemClickListener(mOnItemClickListener);
