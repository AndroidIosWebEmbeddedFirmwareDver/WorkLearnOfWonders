...
import com.wondersgroup.hs.healthcloud.common.huanxin.widget.EaseConversationList;
...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getAllMsgCount() != 0) {
            ...
            holder.time.setText(EaseDateUtil.getTimestampString(new Date(lastMessage.getMsgTime())));
