...
public class JsonMapper {
    ...
    public JsonMapper addExceptFilter(Class<?> clazz, String... propertyArray) {
        if (filterProvider == null) {
            filterProvider = new SimpleFilterProvider();
            filterProvider.setFailOnUnknownId(false);
        }
        filterProvider.addFilter(clazz.getName(), SimpleBeanPropertyFilter.serializeAllExcept(propertyArray));
        mapper.setFilterProvider(filterProvider);
        annotationIntrospector();
        return this;
    }

    public JsonMapper addIncludeFilter(Class<?> clazz, String... propertyArray) {
        if (filterProvider == null) {
            filterProvider = new SimpleFilterProvider();
            filterProvider.setFailOnUnknownId(false);
        }
        filterProvider.addFilter(clazz.getName(), SimpleBeanPropertyFilter.filterOutAllExcept(propertyArray));
        mapper.setFilterProvider(filterProvider);
        return this;
    }
