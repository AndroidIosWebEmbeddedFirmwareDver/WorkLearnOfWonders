...
+ (NSString *)rsaPassword:(NSString *)passwrod {
    //passwrod = [RSA encryptString: passwrod publicKey: [WDGlobal global].bgTask.appConfig.publicKey ? [WDGlobal global].bgTask.appConfig.publicKey :  PUBKEY];
     passwrod = [RSA encryptString: passwrod publicKey: [TaskManager manager].appConfig.common.publicKey ? [TaskManager manager].appConfig.common.publicKey :  PUBKEY];
