...
import com.wonders.health.venus.open.user.module.home.registration.RegistrationDoctorHead;
...
import static com.wonders.health.venus.open.user.R.id.iv_item_doctorlist;
import static com.wonders.health.venus.open.user.R.id.tv_item_doctorlist_date;
import static com.wonders.health.venus.open.user.R.id.tv_item_doctorlist_duty;
import static com.wonders.health.venus.open.user.R.id.tv_item_doctorlist_expert;
import static com.wonders.health.venus.open.user.R.id.tv_item_doctorlist_fee;
import static com.wonders.health.venus.open.user.R.id.tv_item_doctorlist_name;
import static com.wonders.health.venus.open.user.R.id.tv_item_doctorlist_title;
import static com.wonders.health.venus.open.user.R.id.tv_item_doctorlist_visit_level;
