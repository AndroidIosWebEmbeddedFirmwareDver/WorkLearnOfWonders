...
public interface ThirdPartyService {
    ...
    AccountThirdParty wechat(String token, String openid);

    AccountThirdParty weibo(String token);

    AccountThirdParty qq(String token);

    void bind(String thirdPartyId, String userId);
