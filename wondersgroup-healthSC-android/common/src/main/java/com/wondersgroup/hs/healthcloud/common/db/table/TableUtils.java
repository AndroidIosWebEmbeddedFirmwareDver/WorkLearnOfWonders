...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.wondersgroup.hs.healthcloud.common.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.wondersgroup.hs.healthcloud.common.db.table.Id>();

    /* package */
    static synchronized com.wondersgroup.hs.healthcloud.common.db.table.Id getId(Class<?> entityType) {
        ...
        com.wondersgroup.hs.healthcloud.common.db.table.Id id = new com.wondersgroup.hs.healthcloud.common.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.wondersgroup.hs.healthcloud.common.db.table.Id id = getId(entityType);
