 ...
 *
 *     For example: `item in items   ` is a typical pattern when the items come from the database. In this
 *     case the object identity does not matter. Two objects are considered equivalent as long as their `id`
 *     property is same.
 *
 *     For example: `item in items | filter:searchText   ` is a pattern that might be used to apply a filter
 ...
 *
 * - Example: &lt;select ng-options="item.subItem as item.label for item in values   " ng-model="selected"&gt;
