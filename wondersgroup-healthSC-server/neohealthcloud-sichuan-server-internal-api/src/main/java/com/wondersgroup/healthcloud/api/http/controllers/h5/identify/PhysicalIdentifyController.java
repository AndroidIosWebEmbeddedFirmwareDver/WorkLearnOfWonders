package com.wondersgroup.healthcloud.api.http.controllers.h5.identify;
 ...
 */
@RestController("H5PhysicalIdentifyController")
@RequestMapping(value = "/h5/api/physicalIdentify")
