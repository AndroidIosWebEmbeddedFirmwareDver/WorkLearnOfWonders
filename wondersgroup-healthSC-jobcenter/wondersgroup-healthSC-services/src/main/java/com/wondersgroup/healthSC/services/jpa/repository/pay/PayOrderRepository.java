...
public interface PayOrderRepository extends JpaRepository<PayOrder, String> {
    ...
    @Query(nativeQuery = true, value = "select * from tb_pay_order a where a.subject_type = ?1 and a.status = ?2 order by a.update_time desc")
    List<PayOrder> findBySubjectTypeAndStatus(String type, String status);
