...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        mActionPadding = getResources().getDimensionPixelSize(R.dimen.L);
        mOutPadding = getResources().getDimensionPixelSize(R.dimen.M);
        mHeight = getResources().getDimensionPixelSize(R.dimen.actionbar_height);
        initView(context);
    }
    ...
    private void initView(Context context) {
        ...
        UIUtil.setTouchEffect(mLeftText);
        ...
        CalligraphyUtils.applyFontToTextView(getContext(), mLeftText, CalligraphyConfig.get().getFontPath());
        CalligraphyUtils.applyFontToTextView(getContext(), mCenterText, CalligraphyConfig.get().getFontPath());
    ...
    private View inflateAction(Action action) {
        ...
        if (TextUtils.isEmpty(action.getText())) {
            ...
            CalligraphyUtils.applyFontToTextView(getContext(), text, CalligraphyConfig.get().getFontPath());
