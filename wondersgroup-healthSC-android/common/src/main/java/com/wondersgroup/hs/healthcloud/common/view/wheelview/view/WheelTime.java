...
import com.wondersgroup.hs.healthcloud.common.view.wheelview.adapter.NumericWheelAdapter;
...
public class WheelTime {
	...
	public void setItemsVisiable(int itemsVisiable){
		wv_year.setItemsVisible(itemsVisiable);
		wv_month.setItemsVisible(itemsVisiable);
		wv_day.setItemsVisible(itemsVisiable);
		wv_hours.setItemsVisible(itemsVisiable);
		wv_mins.setItemsVisible(itemsVisiable);
	}
...
//        LogUtils.d("bacy" + startYear + "," + endYear + "," + startMonth + "," + endMonth + "," + startDay + "," + endDay);
	}

    private void changeOutRange() {
