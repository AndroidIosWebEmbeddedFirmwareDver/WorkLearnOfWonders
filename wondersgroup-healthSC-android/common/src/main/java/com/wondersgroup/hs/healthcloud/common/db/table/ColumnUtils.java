...
package com.wondersgroup.hs.healthcloud.common.db.table;

import android.text.TextUtils;

import com.wondersgroup.hs.healthcloud.common.db.annotation.Check;
import com.wondersgroup.hs.healthcloud.common.db.annotation.NotNull;
import com.wondersgroup.hs.healthcloud.common.db.annotation.Transient;
import com.wondersgroup.hs.healthcloud.common.db.annotation.Unique;
import com.wondersgroup.hs.healthcloud.common.db.annotation.Column;
import com.wondersgroup.hs.healthcloud.common.db.annotation.Id;
import com.wondersgroup.hs.healthcloud.common.db.annotation.Finder;
import com.wondersgroup.hs.healthcloud.common.db.annotation.Foreign;
import com.wondersgroup.hs.healthcloud.common.db.converter.ColumnConverter;
import com.wondersgroup.hs.healthcloud.common.db.converter.ColumnConverterFactory;
import com.wondersgroup.hs.healthcloud.common.db.sqlite.FinderLazyLoader;
import com.wondersgroup.hs.healthcloud.common.db.sqlite.ForeignLazyLoader;
...
//                LogUtils.d(methodName + " not exist");
    ...
    public static Class<?> getForeignEntityType(com.wondersgroup.hs.healthcloud.common.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.wondersgroup.hs.healthcloud.common.db.table.Finder finderColumn) {
