...
public class Finder extends Column {
    ...
    /* package */ Finder(Class<?> entityType, Field field) {
        ...
        com.wondersgroup.hs.healthcloud.common.db.annotation.Finder finder =
                field.getAnnotation(com.wondersgroup.hs.healthcloud.common.db.annotation.Finder.class);
