...
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    private String getActiveProfile() {
        ...
        if (profiles.length != 0) {
            System.out.println("ActiveProfile--->:" + profiles[0]);
            return profiles[0];
        } else {
            return null;
        }
    }
//    TODO;Swagger2 静态资源配置
    ...
    public RequestMappingHandlerMapping requestMappingHandlerMapping() {
        Boolean isSandbox = "de".equals(getActiveProfile()) || "te".equals(getActiveProfile()) || "scte".equals(getActiveProfile());
