...
//		container.setLayoutParams(layoutParams);
	...
	private void applyLayoutParams() {
		...
		case POSITION_TOP_RIGHT:
			...
			if (badgeMarginRight != -1 && badgeMarginTop != -1) {
	...
	public int getBadgeMarginRight() {
		return badgeMarginRight;
	}

	public void setBadgeMarginRight(int badgeMarginRight) {
	...
	public void setBadgeMarginTop(int badgeMarginTop) {
