...
public interface DepartmentService {
    ...
    List<DoctorInfoDTO> getScheduleByTime(String uid, List<ScheduleNumInfo> scheduleNumInfos);
     ...
     * @return
     */
    List<DoctorInfoDTO> queryScheduleList(String uid, String hospitalCode, String hosDeptCode, String area);
