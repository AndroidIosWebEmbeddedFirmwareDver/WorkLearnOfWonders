 ...
 */
//@Component
public class SynchronDoctor implements CommandLineRunner{
    @Autowired
    ...
    public void run(String... strings) throws Exception {
        ...
        doctorService.synchronInfo();//初始化同步一次数据

        Job job = new Job();
        job.setTaskId("healthSC_synchronDoctor");
        job.setParam("jobType","doctor");
