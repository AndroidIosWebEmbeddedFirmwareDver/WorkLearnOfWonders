 ...
 * 创建时间：2016/1/1 14:30
 */
public class PayAppointFragment extends BaseFragment {
    ...
    protected View onCreateView(LayoutInflater inflater, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_appoint, null, false);
    }
    ...
    private void loadData(final int type) {
        ...
        new OrderManager().getAppointList(UserManager.getInstance().getUser().uid, params,
                    ...
                    public void onSuccess(OrderResponse t) {
                        ...
                        if (mOrderResponse.isListEmpty()) {
                            ...
                            if (mOrderAdapter == null) {
                                mOrderAdapter = new OrderAdapter(mBaseActivity, mOrderResponse.getList(), false);
