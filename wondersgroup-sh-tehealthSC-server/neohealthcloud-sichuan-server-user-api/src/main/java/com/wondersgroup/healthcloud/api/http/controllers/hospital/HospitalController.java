...
public class HospitalController {
    ...
    @VersionRange
    public JsonListResponseEntity<DoctorInfoDTO> queryDoctors(@RequestParam String hospitalCode, @RequestParam String hosDeptCode, @RequestParam(required = false) String area) {
        ;
        JsonListResponseEntity<DoctorInfoDTO> response = new JsonListResponseEntity<>();
        //号源信息查询不分页
        List<DoctorInfoDTO> doctorInfo = departmentService.queryScheduleList(hospitalCode, hosDeptCode, area);
    ...
    @VersionRange
    public JsonListResponseEntity querySchedulByTime(@RequestParam String time, @RequestParam String hospitalCode, @RequestParam String hosDeptCode, @RequestParam(required = false) String area) {
        ...
        //号源信息查询不分页
        List<DoctorInfoDTO> scheduleByTime = departmentService.getScheduleByTime(scheduleNumInfos);
    ...
    @VersionRange
    public JsonResponseEntity querySchedulInfo(@RequestParam String hospitalCode, @RequestParam String hosDeptCode, @RequestParam String hosDoctCode, @RequestParam(required = false) String area) {
