...
import com.wondersgroup.hs.healthcloud.common.view.wheelview.adapter.WheelAdapter;
import com.wondersgroup.hs.healthcloud.common.view.wheelview.listener.OnItemSelectedListener;
import com.wondersgroup.hs.healthcloud.common.view.wheelview.model.IPickerViewData;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(R.color.tc3);
        textColorCenter = getResources().getColor(R.color.tc5);
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.text_size_16);
        labelTextSize = getResources().getDimensionPixelSize(R.dimen.text_size_16);
        ...
        if (attrs != null) {
            ...
            labelTextSize = a.getDimensionPixelOffset(R.styleable.pickerview_pickerview_labelTextSize, labelTextSize);
        }
    ...
    private void initPaints() {
        ...
        Typeface typeface = TypefaceUtils.load(assetManager,  CalligraphyConfig.get().getFontPath());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (counter < itemsVisible) {
            ...
            if (angle >= 90F || angle <= -90F) {
                ...
                if (counter == itemsVisible / 2) {
                    //单位的Label
                    if (label != null) {
                        int drawRightContentStart = (measuredWidth + getTextWidth(paintCenterText, contentText)) / 2;
                        paintCenterText.setTextSize(labelTextSize);
                        //靠右并留出空隙
                        canvas.drawText(label, drawRightContentStart +6*getDensity(), centerY - CENTERCONTENTOFFSET , paintCenterText);
                        paintCenterText.setTextSize(textSize);
                    }
                }
