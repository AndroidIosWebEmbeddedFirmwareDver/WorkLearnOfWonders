                           ...
                           conversationType:(EMConversationType)conversationType
{
    ...
    if (self) {
        ...
        NSLog(@"_conversation:%@",_conversation);
...
- (void)sendTextMessage:(NSString *)text withExt:(NSDictionary*)ext
{
    EMMessage *message = [EaseSDKHelper sendTextMessage:text
                                          ...
                                          messageType:[self _messageTypeFromConversationType]
                                           messageExt:[self avatarAndNickName]];
...
#pragma mark gjj add ext 
- (NSDictionary *)avatarAndNickName {
    
    NSDictionary *dict = @{@"avatar":@"http://tva2.sinaimg.cn/crop.0.0.1024.1024.180/718878b5jw8esr2geokzkj20sg0sg0ts.jpg",@"nickName":@"真名"};
    return dict;
}
