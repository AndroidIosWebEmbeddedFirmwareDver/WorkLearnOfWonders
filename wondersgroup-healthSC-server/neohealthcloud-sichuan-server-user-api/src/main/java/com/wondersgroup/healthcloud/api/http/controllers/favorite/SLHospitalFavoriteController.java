 ...
 */
@RestController
@RequestMapping("/api/sl/favorite/hospital")
public class SLHospitalFavoriteController {
    ...
    @GetMapping("/list")
    @VersionRange
    public JsonListResponseEntity<HospitalDTO> hospitalList(@RequestHeader(name = "city-code", defaultValue = "510122000000") String cityCode,
        ...
        List<Hospital> hospitals = favoriteService.getFavoriteHospitals(uid, flag, 10, cityCode);
