...
#import "SCPreorderNumberVC.h"

@interface SCPreorderNumberVC ()<UITableViewDataSource,UITableViewDelegate,UISearchResultsUpdating>

@end

@implementation SCPreorderNumberVC
{
        //数据源的表格
