...
public class ReferralServiceAllAdapter extends BaseAdapter<ReferralServiceList,ReferralServiceAllAdapter.ViewHolder>{


    private Context mContext;
    public List<ReferralServiceList> getItems(){
        return mItems;
    }

    public ReferralServiceAllAdapter(Context ctx, List<ReferralServiceList> list) {
        super(ctx, list);
        mContext = ctx;
    }
    @Override
    public ReferralServiceAllAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
