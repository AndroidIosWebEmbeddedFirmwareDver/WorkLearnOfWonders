...
@interface SCDoctorSchedulingRuleCell ()
...
@implementation SCDoctorSchedulingRuleCell
...
- (void)setupView {
    ...
    WS(weakSelf)
    self.titleLabel = [UISetupView setupLabelWithSuperView:self.contentView withText:@"" withTextColor:[UIColor tc3Color] withFontSize:12];
