app.controller('HealthBannerSettingCtrl', ['$scope', '$http', '$state','$filter', function($scope, $http, $state,$filter) {
    $scope.pager = {
        "totalPages":0,     //总页数
        "totalElements":0,  //总条数
        "size": 10,         //页大小
    ...
    $scope.editBanner = function(id){
        $state.go('app.hs.bannerSettingEdit',{ id : id });
    };
