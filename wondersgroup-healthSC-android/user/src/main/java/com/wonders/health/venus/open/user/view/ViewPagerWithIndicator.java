...
import com.wondersgroup.hs.healthcloud.common.view.AutoScrollViewPager;
...
//            mViewPager.setCurrentItem(pos);
     ...
     * @since 1.0
     */
    public void initViewPager(final BitmapTools mBitmapTools, final List<String> imageUrl,final OnViewClickListener onViewClickListener) {
...
//            mCustomIndicator.setCount(mCount);
            ...
            PagerAdapter adapter = new PagerAdapter() {
                ...
                public Object instantiateItem(ViewGroup container, int position) {
                    ...
                    mBitmapTools.display(imageView, imageUrl.get(pos), BitmapTools.SizeType.LARGE);
                    imageView.setOnClickListener(new OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            if (onViewClickListener != null) {
                                onViewClickListener.onViewClick(view, pos);
                            }
                        }
                    });
