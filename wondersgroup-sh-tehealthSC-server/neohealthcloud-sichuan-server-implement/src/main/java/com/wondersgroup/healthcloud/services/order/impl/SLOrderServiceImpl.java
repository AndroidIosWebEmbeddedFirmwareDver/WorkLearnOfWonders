...
public class SLOrderServiceImpl implements SLOrderService {
    ...
    @Autowired
    private OrderClient orderClientSL;
    ...
    @Override
    public List<QueryOrderInfoListResponse.Result> getOrderList(QueryOrderInfoListRequest.OrderInfo orderInfo) {
        ...
        String url = serverConfigServiceImpl.queryApiUrl("510122000000", "1");
        orderClientSL.setDefaultUri(url);
        return orderClientSL.queryOrderInfoList(JaxbUtil.convertToXml(queryOrderInfoListReq, "GBK"));
    }

    @Override
    public GetOrderDetailInfoResponse.Result getOrderDetail(GetOrderDetailInfoRequest.OrderInfo orderInfo) {
        ...
        String url = serverConfigServiceImpl.queryApiUrl("510122000000", "1");
        orderClientSL.setDefaultUri(url);
        return orderClientSL.getOrderDetailInfo(JaxbUtil.convertToXml(getOrderDetailInfoReq, "GBK"));
    }

    @Override
    public SubmitOrderByUserInfoResponse submitOrder(SubmitOrderByUserInfoRequest.OrderInfo orderInfo) {
        ...
        String url = serverConfigServiceImpl.queryApiUrl("510122000000", "1");
        orderClientSL.setDefaultUri(url);
        return orderClientSL.submitOrderByUserInfo(JaxbUtil.convertToXml(submitOrderByUserInfoReq, "GBK"));
    }

    @Override
    public OrderCancelInfoResponse cancelOrder(OrderCancelInfoRequest.OrderInfo orderInfo) {
        ...
        String url = serverConfigServiceImpl.queryApiUrl("510122000000", "1");
        orderClientSL.setDefaultUri(url);
        return orderClientSL.orderCancelInfo(JaxbUtil.convertToXml(orderCancelInfoReq, "GBK"));
    }

    @Override
    public OrderPayCompletedResponse orderPayCompleted(OrderPayCompletedRequest.OrderInfo orderInfo) {
        ...
        String url = serverConfigServiceImpl.queryApiUrl("510122000000", "1");
        orderClientSL.setDefaultUri(url);
        return orderClientSL.orderPayCompleted(JaxbUtil.convertToXml(orderPayCompletedReq, "GBK"));
    }
}
