...
import com.wonders.health.venus.open.user.module.home.AreaSelectActivity;
import com.wonders.health.venus.open.user.module.home.registration.adapter.HospitalListAdapter;
import com.wonders.health.venus.open.user.module.home.search.RegistrationHospitalSearchActivity;
import com.wonders.health.venus.open.user.module.mine.AddCardTypeActivity;
    ...
    protected void initViews() {
        ...
        mRecycleViewHospitals.setOnItemClickListener(new BaseRecyclerView.OnItemClickListener() {
            ...
            public void onItemClick(RecyclerView parent, View view, int position, long id) {
                ...
                if (hospital != null) {
                    if(getIntent().hasExtra("JUMP_TAG")){
                        Intent intent = new Intent();
                        Bundle mBundle=  new Bundle();
                        mBundle.putSerializable("hospital",hospital);
                        intent.putExtras(mBundle);
                        setResult(AddCardTypeActivity.EXTRA_KEY_CODE,intent);
                        finish();
