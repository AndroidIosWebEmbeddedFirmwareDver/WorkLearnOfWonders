...
import com.wondersgroup.healthcloud.common.http.filters.interceptor.InternalMenuAuthInterceptor;
...
public class WebConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new InternalMenuAuthInterceptor(basicInfoService, sessionUtil));
