...
CGFloat const EaseConversationCellPadding = 14;
...
+ (void)initialize
{
    ...
    cell.titleLabelColor = [UIColor tc1Color];
    cell.titleLabelFont = [UIFont systemFontOfSize:16];
    cell.detailLabelColor = [UIColor tc3Color];
    cell.detailLabelFont = [UIFont systemFontOfSize:14];
    cell.timeLabelColor = [UIColor tc3Color];
