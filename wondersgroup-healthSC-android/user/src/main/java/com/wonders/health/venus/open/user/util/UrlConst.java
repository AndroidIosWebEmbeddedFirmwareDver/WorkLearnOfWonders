...
public class UrlConst {
    ...
    //我的医院就诊卡
    public static final String GET_CARD_TYPE = BASE_URL + "/user/online/medcial/cards/findAllByUid";
    public static final String POST_CREATE_CARD = BASE_URL + "/user/online/medcial/cards/create";
    public static final String POST_UPDATE_LOGIC_DELETE_CARD = BASE_URL + "/user/online/medcial/cards/updateLogicDelete";
    ...
    public static final String TEAM_LIST = BASE_URL+"/family/doctor/teamList";
}
